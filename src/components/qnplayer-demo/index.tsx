...
function StreamContainer() {
  ...
  React.useEffect(() => {
    player.init({ width, height, className, controls, playsinline, objectFit, volumn, audioOnly });
  ...
  return <div id="stream-container">
    ...
    <div id="control-container">
      ...
      <div id="stream-control-container">
        ...
        <button className="stream-btn" onClick={() => {
          player.setConfig({ width, height, className, controls, playsinline, objectFit, volumn, audioOnly });
        }}>setConfig</button>
      </div>
    </div>
